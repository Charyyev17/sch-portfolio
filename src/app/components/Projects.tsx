...
function Projects({}: Props) {
  const projects = [
    {
      img: "https://user-images.githubusercontent.com/66562485/246669781-d9a8a463-a5fd-4b5b-b76f-07719ba83639.png",
      name: "Booking App",
      url: "soon...",
      summary:
        "This Website developed by using Reactjs, Nodejs, MongoDB",
    },
    {
